...
class _HomePageClientState extends State<HomePageClient> {
  ...
  _getCategories() async {
    final menu = await this.menuService.getCategories();
    print('Categorias');
    print(menu);
            ...
            Column(
              ...
              children: <Widget>[
                ...
                Expanded(
                  child: Row(
                    children: <Widget>[
                      _itemCategory('Bebidas', 'assets/images/Bebidas.jpg'),
                ...
                Expanded(
                  child: Row(
                    children: <Widget>[
                      _itemCategory(
                          'Especialidades', 'assets/images/Especialidades.jpg'),
                    ...
                    children: <Widget>[
                      ...
                      Container(
                          ...
                          child: new ListView(
                            ...
                            children: <Widget>[
                              _itemPromo(
                                  'Cerveza 2x1', 'assets/images/Bebidas.jpg'),
                              _itemPromo('Hamburguesa con papas',
                                  'assets/images/food.jpg'),
                              _itemPromo(
                                  'Sushi + cerveza', 'assets/images/Especialidades.jpg'),
                              _itemPromo(
